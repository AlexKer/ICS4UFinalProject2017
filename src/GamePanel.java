...
public class GamePanel extends JPanel implements Runnable, KeyListener{
	 ...
	 * -For new methods added and justifications please see explanation 
	 * of their uses directly above method signatures
	 * 
	 * Class changes
	...
	private boolean playerStart=false; //checks whether player hit the space bar to make first jump
